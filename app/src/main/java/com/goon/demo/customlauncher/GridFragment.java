...
class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv.setColumnWidth(convertDpToPixels(200, getActivity()));/*60*/
        lv.setStretchMode(GridView.STRETCH_COLUMN_WIDTH);
        lv.setNumColumns(GridView.AUTO_FIT);
        lv.setHorizontalSpacing(convertDpToPixels(50, getActivity()));/*20*/
        lv.setVerticalSpacing(convertDpToPixels(50, getActivity()));/*20*/
